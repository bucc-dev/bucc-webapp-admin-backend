...
permissionRouter.route('/profile/permissions/get').get(authMiddleware, minimalRateLimiter, PermissionController.getPermission);

permissionRouter.route('/profile/permissions/check').get(authMiddleware, minimalRateLimiter, PermissionController.checkPermission);
